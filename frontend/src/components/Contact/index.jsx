...
const Contact = () => {
  ...
  return (
    <div className="contact-wrapper">
      {/* Navbar is provided at app-level to avoid duplicate fixed header/gap */}
      ...
      <div className="contact-container">
        ...
        <div className="contact-info-strip">
          {[
            { icon: "✉", label: "Email", value: "nikhilshingade299@gmail.com" },
            { icon: "⏱", label: "Response Time", value: "Within 24 hours" },
            { icon: "📍", label: "Location", value: "Vasai, India" },
          ].map((item, i) => (
